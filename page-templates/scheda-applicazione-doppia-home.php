...
$box_immagine_URL_desktop = $box_immagine['sizes']['app_double_size_desktop'];
$box_immagine_URL_tablet = $box_immagine['sizes']['app_double_size_desktop'];
...
<div class="flex-hold-child flex-hold-child-double bg-2">
  <div class="scheda-prodotto-img">
    ...
    <picture>
      ...
      <img data-src="<?php echo $box_immagine_URL_mobile; ?>" title="<?php echo $box_4_immagine_1['title']; ?> - <?php echo get_bloginfo( 'name' ); ?>" alt="<?php echo $box_4_immagine_1['alt']; ?> - <?php echo get_bloginfo( 'name' ); ?>"  class="lazy" />
    </picture>
  </div>
